      ...
      if (evaluacionData && proveedores.length > 0 && personas.length > 0) {
        ...
        if (evaluacionData.fecha_evaluacion) {
          ...
          if (añoEvaluacion > 2025) {
            setErrorMessage(
              'Esta vista solo permite editar evaluaciones con fecha del año 2025 o anterior. Esta evaluación es del año ' +
                añoEvaluacion +
                '.'
            );
            setTimeout(() => {
        ...
        const mapearTextoAValor = (
          ...
          if (criterioId === 'cumplimiento') {
            ...
            if (
              textoUpper.includes('CUMPLEN LA FECHA') ||
              (textoUpper.includes('CUMPLE') && !textoUpper.includes('GENERALMENTE'))
            ) {
              return 'MEDIO';
            }
            ...
            if (
              textoUpper.includes('RETRASA OCASIONALMENTE') ||
              textoUpper.includes('RETRASA OCASIONAL')
            ) {
              return 'BAJO';
            }
            if (
              textoUpper.includes('GENERALMENTE SE RETRASA') ||
              textoUpper.includes('GENERALMENTE RETRASA')
            ) {
              return 'MUY_BAJO';
            }
          }
